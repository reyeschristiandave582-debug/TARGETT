...
const CRUMBL_URL = "https://giftclick.org/aff_c?offer_id=250&aff_id=183864&source=target";
    ...
    >
      <div className="relative inline-block animate-float will-change-transform">
            ...
            <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
              <img 
                src="https://i.imgur.com/fcwWYxV.png" 
        ...
        <div className="relative">
            ...
            <span className="text-[#cc0000]">Unlock</span>
            <span className="text-[#cc0000]">Target</span>
            <div className="flex items-center -ml-1">
              <Gift className="w-6.0 h-6.0 text-[#cc0000] fill-transparent" />
            </div>
          </h1>
        </div>
